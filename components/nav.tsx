...
export function Nav(props: IProps) {
  ...
  const { menu } = props
  return (
    <nav className="bg-white borer-gray-200">
      <div className="max-w-screen-x1 flex flex-wrap items-center justify-between mx-auto p-4">
        <Link href={HOST} className="flex items-center space-x-3">
          <div className="flex gap-x-2">
            ...
            <div className="text-2xl text-orange-700 font-bold">LAS</div>
          </div>
        </Link>
        ...
        hover:bh-gray-100 focus: outline-none focus:ring-2 focus:ring-gray-200"
        >
